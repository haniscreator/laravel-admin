<template>
  <div class="max-w-2xl mx-auto py-8 shadow p-6">
    <h1 class="text-2xl font-bold mb-6 text-gray-800 dark:text-white">Create New Item</h1>
  ...
  <div v-if="form.errors.album_id" class="text-red-500">{{ form.errors.album_id }}</div>
      ...
      <!-- Media Upload -->
      <div class="mb-4">
        <label class="block font-medium text-gray-800 dark:text-gray-200 mb-1">Media File</label>
        <div class="flex items-center gap-3">
          ...
          <span class="text-sm text-gray-700 dark:text-gray-300" v-if="selectedMediaName">
            {{ selectedMediaName }}
            </span>
        </div>
...
const page = usePage()
//const albums = page.props.albums
