<template>
  <div class="relative" ref="dropdownRef">
    <div
      ...
      class="flex items-center gap-2 cursor-pointer px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition"
    >
      <img
        src="/images/admin.png"
        alt="User"
        class="h-7 w-7 rounded-full border border-gray-300 dark:border-gray-600"
      />
